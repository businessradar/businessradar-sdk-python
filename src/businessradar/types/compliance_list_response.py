...
__all__ = ["ComplianceListResponse", "Company"]
...
class ComplianceListResponse(BaseModel):
    ...
    results_changed_at: Optional[datetime] = None

    reviewed_results_count: Optional[int] = None
    ...
    unreviewed_results_count: Optional[int] = None
