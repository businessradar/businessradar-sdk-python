...
__all__ = ["CompanyCreateMissingCompanyInvestigationParams"]


class CompanyCreateMissingCompanyInvestigationParams(TypedDict, total=False):
    country: Required[CountryEnum]
    """
    - `AF` - Afghanistan
    - `AX` - Aland Islands
    - `AL` - Albania
