...
from businessradar.types.ext.v3 import Portfolio, PortfolioListResponse
...
class TestPortfolios:
    ...
    def test_method_create(self, client: Businessradar) -> None:
        portfolio = client.ext.v3.portfolios.create(
            name="x",
        )
    ...
    def test_raw_response_create(self, client: Businessradar) -> None:
        response = client.ext.v3.portfolios.with_raw_response.create(
            name="x",
        )
    ...
    def test_streaming_response_create(self, client: Businessradar) -> None:
        with client.ext.v3.portfolios.with_streaming_response.create(
            name="x",
        ) as response:
    ...
    def test_method_list(self, client: Businessradar) -> None:
        portfolio = client.ext.v3.portfolios.list()
    ...
    def test_raw_response_list(self, client: Businessradar) -> None:
        response = client.ext.v3.portfolios.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Businessradar) -> None:
        with client.ext.v3.portfolios.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPortfolios:
    ...
    async def test_method_create(self, async_client: AsyncBusinessradar) -> None:
        portfolio = await async_client.ext.v3.portfolios.create(
            name="x",
        )
        assert_matches_type(Portfolio, portfolio, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncBusinessradar) -> None:
        response = await async_client.ext.v3.portfolios.with_raw_response.create(
            name="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncBusinessradar) -> None:
        async with async_client.ext.v3.portfolios.with_streaming_response.create(
            name="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncBusinessradar) -> None:
        portfolio = await async_client.ext.v3.portfolios.list()
        assert_matches_type(PortfolioListResponse, portfolio, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBusinessradar) -> None:
        response = await async_client.ext.v3.portfolios.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBusinessradar) -> None:
        async with async_client.ext.v3.portfolios.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
