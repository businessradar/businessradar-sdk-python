...
from businessradar.types.ext.v3.articles import ArticleExport
...
class TestExport:
    ...
    def test_method_create(self, client: Businessradar) -> None:
        export = client.ext.v3.articles.export.create(
            file_type="PDF",
            filters={},
        )
    ...
    def test_raw_response_create(self, client: Businessradar) -> None:
        response = client.ext.v3.articles.export.with_raw_response.create(
            file_type="PDF",
            filters={},
        )
    ...
    def test_streaming_response_create(self, client: Businessradar) -> None:
        with client.ext.v3.articles.export.with_streaming_response.create(
            file_type="PDF",
            filters={},
        ) as response:
    ...
    def test_method_retrieve(self, client: Businessradar) -> None:
        export = client.ext.v3.articles.export.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Businessradar) -> None:
        response = client.ext.v3.articles.export.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Businessradar) -> None:
        with client.ext.v3.articles.export.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Businessradar) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_id` but received ''"):
            client.ext.v3.articles.export.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncExport:
    ...
    async def test_method_create(self, async_client: AsyncBusinessradar) -> None:
        export = await async_client.ext.v3.articles.export.create(
            file_type="PDF",
            filters={},
        )
        assert_matches_type(ArticleExport, export, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncBusinessradar) -> None:
        response = await async_client.ext.v3.articles.export.with_raw_response.create(
            file_type="PDF",
            filters={},
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncBusinessradar) -> None:
        async with async_client.ext.v3.articles.export.with_streaming_response.create(
            file_type="PDF",
            filters={},
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_retrieve(self, async_client: AsyncBusinessradar) -> None:
        export = await async_client.ext.v3.articles.export.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ArticleExport, export, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBusinessradar) -> None:
        response = await async_client.ext.v3.articles.export.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBusinessradar) -> None:
        async with async_client.ext.v3.articles.export.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBusinessradar) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_id` but received ''"):
            await async_client.ext.v3.articles.export.with_raw_response.retrieve(
                "",
            )
